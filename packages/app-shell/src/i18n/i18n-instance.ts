...
export const translationResources = {
  "zh-CN": {
    ...
    "errors.spec_source_workspace_root":
      "不能选择工作区根目录，请选择其下的子文件夹（例如 openspec/specs）。",
    "errors.spec_document_not_found":
      "该 Spec 文档已不存在或不再属于当前目录配置。",
    ...
    "specs.sourcesDescription":
      "这些设置作用于项目根目录及所有 worktree。添加目录时请选择当前工作区内的子文件夹。",
  ...
  "en-US": {
    ...
    "errors.spec_source_outside_workspace":
      "The selected Spec directory is outside the current workspace.",
    "errors.spec_source_workspace_root":
      "The workspace root cannot be used as a Spec source. Choose a subdirectory such as openspec/specs.",
    "errors.spec_document_not_found":
      "The Spec document no longer exists or is outside the configured sources.",
    ...
    "specs.sourcesDescription":
      "These settings apply to the project root and every worktree. When adding a directory, choose a subfolder inside the current workspace.",
