...
export const translationResources = {
  "zh-CN": {
    ...
    "settings.roles.contentHint": "内容暂时只读；名称和描述仍可编辑。",
    ...
    "settings.skills.contentHint": "内容暂时只读；名称和描述仍可编辑。",
  ...
  "en-US": {
    ...
    "settings.roles.contentHint": "Content is read-only for now; name and description remain editable.",
    ...
    "settings.skills.contentHint": "Content is read-only for now; name and description remain editable.",
