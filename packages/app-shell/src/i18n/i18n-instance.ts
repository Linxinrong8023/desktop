...
export const translationResources = {
  "zh-CN": {
    ...
    "settings.roles.contentHint": "支持 Markdown 所见即所得编辑；留空可清除内容。",
    ...
    "settings.skills.contentHint": "支持 Markdown 所见即所得编辑；留空可清除内容。",
  ...
  "en-US": {
    ...
    "settings.roles.contentHint": "Edit Markdown with live rich-text formatting; leave empty to clear the content.",
    ...
    "settings.skills.contentHint": "Edit Markdown with live rich-text formatting; leave empty to clear the content.",
