...
export const endpoints = {
  ...
  replyTaskDiffComment: {
    ...
    responseMode: "unary",
    pathParams: [
      { rustFieldName: "task_id", wireName: "taskId" },
      { rustFieldName: "comment_id", wireName: "commentId" },
    ],
    queryParams: [],
    hasJsonBody: true,
  },
  ...
  getVersion: {
    ...
    responseMode: "unary",
    pathParams: [
      { rustFieldName: "workflow_id", wireName: "workflowId" },
      { rustFieldName: "version", wireName: "version" },
    ],
    queryParams: [],
    hasJsonBody: false,
  },
